...
"weight_loss":3,
    ...
    #map symptom with input
    s1=symptoms[symptom1]
    s2=symptoms[symptom2]
    s3=symptoms[symptom3]

    last=[(s1),(s2),(s3)]

    input_query = [np.array(last)]
    result = model.predict(input_query)

    return render_template('index.html', prediction_text='The disease can be : {}'.format(result))
